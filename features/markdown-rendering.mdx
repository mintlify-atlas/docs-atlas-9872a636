---
title: "Markdown Rendering in leaftext: CommonMark + GFM"
sidebarTitle: "Markdown Rendering"
description: "leaftext renders the full CommonMark spec and GitHub Flavored Markdown, plus GitHub extras: syntax highlighting, Mermaid, math, alerts, footnotes, and emoji."
---
...
Raw HTML inside Markdown is sanitized using [ammonia](https://github.com/nicowillis/ammonia) before it reaches the WebView.
