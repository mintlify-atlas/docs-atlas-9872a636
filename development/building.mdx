---
title: "Build leaftext from source on macOS, Windows, and Linux"
sidebarTitle: "Building"
description: "Set up a Rust development environment, clone the repository, and run the leaftext verification suite with just verify before contributing."
---
...
<Note>
  On Linux, install `libwebkit2gtk-4.1-dev` (or the equivalent package for your
