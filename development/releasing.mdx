---
title: "Cut a leaftext release with just release <version>"
sidebarTitle: "Releasing"
description: "leaftext uses a just release command to bump the version, tag, and push. CI automatically builds Windows MSI, macOS DMG, and Linux artifacts."
---
...
<Note>
  The release script uses `--no-sign-commit`, so no GPG key is required to cut a
